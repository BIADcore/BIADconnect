--- 
title: "Example R script for converting local coordinates to WGS 84"
...
vignette: >
  %\VignetteIndexEntry{Example R script for converting local coordinates to WGS 84}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

Need real data to replace placeholder `___`
