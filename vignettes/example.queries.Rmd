--- 
title: "Example R script for querying BIAD"
...
vignette: >
  %\VignetteIndexEntry{Example R script for querying BIAD}
...
knitr::kable(type.count, col.names = c("Type", "Count"), caption = "PhaseType Entries")
sum(type.count)
```
...
knitr::kable(query[1:min(10,nrow(query)),])
```
...
#	coord_flip()
barplot(query[,2],horiz=T,ylab="Country",xlab="Frequency",title=paste0("aDNA samples in (local) BIAD [n=",sum(query[,2]),"]"))
#--------------------------------------------------------------------------------------
disconnect()
#--------------------------------------------------------------------------------------
